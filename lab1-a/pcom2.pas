...
type                                                        (*describing:*)
     ...
     chtp = (letter,number,special,illegal,
             chstrquo,chcolon,chperiod,chlt,chgt,chlparen,chspace,chlcmt,chd);
...
(*-------------------------------------------------------------------------*)
  ...
  1:
    ...
    case chartp[ch] of
      letter:
        begin k := 0; ferr := true;
          ...
          until chartp[ch] in [special,illegal,chstrquo,chcolon,
                                chperiod,chlt,chgt,chlparen,chspace,chlcmt,chd];
          if k >= kk then kk := k
          else
      ...
      chd:
        begin nextch; sy := mulop;
          if ch = '/' then
            begin op := idiv; nextch end
          else op := rdiv
        end;
      chlparen:
       begin nextch;
